	...
	steps: {
		dataStructures: {
			common: {
				...
				snippet: {
					...
					caseDescription: {
						...
						leftRightRotate: 'Left Right Case: Left Rotate then Right Rotate',
						rightLeftRotate: 'Right Left Case: Right Rotate then Left Rotate',
					},
				},
			},
			avlTree: {
				updateHeightBalanceData: 'Check height and balance',
				rotateLeftData: 'Rotate left at root {oldRootId}',
				rotateRightData: 'Rotate right at root {oldRootId}',
			},
			rbTree: {
				colorNodeData: 'Color node {nodeId} to {color}',
				rotateLeftData: 'Rotate left at root {oldRootId}',
				rotateRightData: 'Rotate right at root {oldRootId}',
				fixupData: 'Fix: {reason}',
				snippet: {
			...
			linkedList: {
				...
				compareData: 'Compare search value {searchValue} with value {currentValue}',
				traverseNextData: 'Traverse to next node',
				traverseToTailData: 'Traverse to tail',
				foundData: 'Found value {value} at position {position}',
			...
			bTree: {
				...
				chooseBranchData: 'Choose child {childIndex}',
				chooseBranchBetweenData: 'Choose child {childIndex} ({lowerBound} < {value} < {upperBound})',
				chooseBranchGreaterThanData: 'Choose child {childIndex} ({value} > {lowerBound})',
				chooseBranchLessThanData: 'Choose child {childIndex} ({value} < {upperBound})',
