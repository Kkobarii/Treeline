	...
	steps: {
		dataStructures: {
			...
			avlTree: {
				...
				rotateLeftData: 'Rotace doleva v kořeni {oldRootValue}',
				rotateRightData: 'Rotace doprava v kořeni {oldRootValue}',
			},
			rbTree: {
				colorNodeData: 'Obarvit uzel {nodeValue} na {color}',
				rotateLeftData: 'Rotace doleva v kořeni {oldRootValue}',
				rotateRightData: 'Rotace doprava v kořeni {oldRootValue}',
				checkRedRule: 'Kontrola dvojitého červeného bodu v uzlu {nodeValue}: {result}',
				checkBlackRule: 'Kontrola porušení černé výšky v uzlu {nodeValue}: {result}',
				blackOkay: 'Odebraný uzel byl červený, žádné porušení černé výšky',
				snippet: {
					red: 'červený',
					black: 'černý',
					correct: 'V pořádku',
					incorrect: 'Porušení detekováno',
					uncleRedInsert: 'Strýc je červený. Přebarvit rodiče, strýce a prarodiče.',
					...
					uncleRedInsertSym: 'Strýc je červený (vpravo). Přebarvit rodiče, strýce a prarodiče.',
					uncleBlackTriangleInsertSym: 'Strýc je černý (vpravo), případ trojúhelníku. Rotace doprava v rodiči.',
					uncleBlackLineInsertSym: 'Strýc je černý (vpravo), případ přímky. Rotace doleva v prarodiči.',
					siblingRed: 'Sourozenec je červený. Rotace a přebarvení.',
					siblingBlackTwoBlack: 'Sourozenec je černý se dvěma černými potomky. Přebarvit sourozence a rodiče.',
					...
					siblingRedSym: 'Sourozenec je červený (vpravo). Rotace a přebarvení.',
					siblingBlackTwoBlackSym: 'Sourozenec je černý (vpravo) se dvěma černými potomky. Přebarvit sourozence a rodiče.',
			...
			heap: {
				...
				compareWithChildrenData: 'Porovnat uzel a potomky',
				compareWithChildrenHasLargestData: 'Porovnat uzel a potomky - potřeba výměy',
				compareWithChildrenCorrectData: 'Porovnat uzel a potomky - správná pozice',
				compareWithParentNeedsSwapData: 'Porovnat s rodičem - potřeba výměny',
				compareWithParentCorrectData: 'Porovnat s rodičem - správná pozice',
			...
			linkedList: {
				...
				foundData: 'Nalezena hodnota {value}',
