	...
	steps: {
		dataStructures: {
			...
			bTree: {
				...
				chooseBranchData: 'Vybrat potomka {childIndex}',
				chooseBranchBetweenData: 'Vybrat potomka {childIndex} ({lowerBound} < {value} < {upperBound})',
				chooseBranchGreaterThanData: 'Vybrat potomka {childIndex} ({value} > {lowerBound})',
				chooseBranchLessThanData: 'Vybrat potomka {childIndex} ({value} < {upperBound})',
