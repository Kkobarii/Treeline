<script lang="ts">
	...
	let operationManager: OperationManager = new OperationManager(StructureType.Stack, 5);
</script>

<h1 class="page-title">{t('dataStructures.stack')}</h1>
<div class="page-layout">
	<StackVisual {operationManager} />
