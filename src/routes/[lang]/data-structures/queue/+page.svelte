<script lang="ts">
	...
	let operationManager: OperationManager = new OperationManager(StructureType.Queue, 5);
</script>

<h1 class="page-title">{t('dataStructures.queue')}</h1>
<div class="page-layout">
	<QueueVisual {operationManager} />
