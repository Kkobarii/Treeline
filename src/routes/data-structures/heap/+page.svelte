<script lang="ts">
	import HeapControls from '$lib/data-structures/controls/HeapControls.svelte';
	...
	let operationManager: OperationManager = new OperationManager(StructureType.Heap);
</script>
